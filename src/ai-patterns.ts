...
export const AI_PATTERNS: AiPattern[] = [
  ...
  { ...K([], "Possible passive construction detected.", "Prefer an active subject where it improves clarity.", "language", "medium", [/\b(?:is|are|was|were|be|been|being|get|gets|got)\s+\w+(?:ed|en|lt|ld|wn|ne|rt|pt)\b/gi]), id: "passive_voice", name: "Passive voice" },
